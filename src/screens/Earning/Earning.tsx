            ...
            <View className='flex-row flex-wrap justify-between mt-2 mb-2'>
                {firstTwoView?.map(item => <View key={item} className='rounded-lg overflow-hidden' style={{ width: width * 0.45 }}>
                    <LinearGradient colors={["#212121", "#212121"]} style={{ padding: 10 }} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
                        <View className='flex-row justify-between items-center'>
                            <Image source={require("../../../assets/e-icon/Wallet.png")} />
                            <Text className={`${item == 1 ? "text-[#4ADE80]" : "text-[#FB923C]"}`}>{item == 1 ? "Availebe" : "Pending"}</Text>
                        </View>
                        <Text className='text-white text-xl mt-2'>৳120,000</Text>
                        <Text className='text-[#DCF3FF]'>{`${item == 1 ? "For Withdrawal" : "Processing"}`}</Text>
                    </LinearGradient>
                </View>)}
            </View>
            ...
            <View className='bg-[#212121] p-3 rounded-lg'>
                ...
                <View className='bg-[#121212] p-1 rounded-md mt-2'>
                    <View className='flex-row justify-between p-1'>
                        <Text className='text-white text-lg'>Order #84739</Text>
                        <Text className='text-[#4ADE80]'>৳2,500</Text>
                    </View>
                    <View className='flex-row justify-between p-1 mt-1'>
                        <Text className='text-[#9CA3AF] text-base'>Jun 24, 2024</Text>
                        <Text className='text-[#4ADE80]'>Paid</Text>
                    </View>
                </View>
                ...
                <View className='bg-[#121212] p-1 rounded-md mt-2'>
                    <View className='flex-row justify-between p-1'>
                        <Text className='text-white text-lg'>Order #84739</Text>
                        <Text className='text-[#FB923C]'>৳2,500</Text>
                    </View>
                    <View className='flex-row justify-between p-1 mt-1'>
                        <Text className='text-[#9CA3AF] text-base'>Jun 24, 2024</Text>
                        <Text className='text-[#FB923C]'>Paid</Text>
                    </View>
