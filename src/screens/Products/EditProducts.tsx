    ...
    return (
        <ScrollView className='flex-1 bg-[#121212] p-5' contentContainerStyle={{ paddingBottom: 100 }}>
                    ...
                    <View className="flex-row gap-2 relative">
                        {demo.map((img) => (
                            ...
                            >
                                ...
                                <Image source={require("../../../assets/e-icon/productDetails.png")} resizeMode='contain' style={{ width: "100%", height: "100%" }} />
            ...
            <TouchableOpacity className='bg-[#1D3725] mt-3 mb-2 items-center p-3 rounded-lg'>
                <Text className='text-white font-instrumentSansBold'>Change Images</Text>
            </TouchableOpacity>
