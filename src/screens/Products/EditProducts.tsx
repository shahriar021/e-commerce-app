...
const EditProducts = () => {
    ...
    const [isAvailble, setIsAvailable] = useState(false);
     ...
     console.log(data?.data?.product[0],"edit")
    ...
    return (
        ...
        >
            ...
            <TextInput
                ...
                value={data?.data?.product[0]?.productName}
            ...
            <TextInput
                className="mt-2 mb-2 bg-[#2C2C2C] p-3 rounded-lg"
                value={data?.data?.product[0]?.shortDescription}
            ...
            <View className="flex-row items-center mt-2 gap-4 border rounded-xl bg-[#2C2C2C] px-1">
                <TextInput
                    className="mt-2 mb-2 bg-[#2C2C2C] p-3 rounded-lg"
                    value={data?.data?.product[0]?.category}
                    placeholder="Describe fabric, fit, style..."
                    style={{ color: "#ADAEBC" }}
                    placeholderTextColor={"#ADAEBC"}
                />
            ...
            <TextInput
                className="mt-2 mb-2 bg-[#2C2C2C] p-3 rounded-lg"
                value={data?.data?.product[0]?.totalQuantity}
                placeholder="e.g., Embroidered Red Kurti"
                style={{ color: "#ADAEBC" }}
                placeholderTextColor={"#ADAEBC"}
            />
            ...
            <TextInput
                className="mt-2 mb-2 bg-[#2C2C2C] p-3 rounded-lg"
                value={data?.data?.product[0]?.price}
                placeholder="e.g., Embroidered Red Kurti"
                style={{ color: "#ADAEBC" }}
                placeholderTextColor={"#ADAEBC"}
            />
            ...
            <TextInput
                className="mt-2 mb-2 bg-[#2C2C2C] p-3 rounded-lg"
                value={data?.data?.product[0]?.discountPrice}
                placeholder="e.g., Embroidered Red Kurti"
                style={{ color: "#ADAEBC" }}
                placeholderTextColor={"#ADAEBC"}
            />
            ...
            <TextInput
                className="mt-2 mb-2 bg-[#2C2C2C] p-3 rounded-lg"
                value={data?.data?.product[0]?.shippingNote}
                placeholder="e.g., Embroidered Red Kurti"
                style={{ color: "#ADAEBC" }}
                placeholderTextColor={"#ADAEBC"}
            />
