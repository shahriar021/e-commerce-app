    ...
    navigation.setOptions({
        ...
        headerLeft: () => (
            <TouchableOpacity className='flex-row gap-2 items-center' onPress={() => navigation.goBack()}>
                ...
                <View className=''>
                    <Text className='font-prostoOne text-white text-2xl'>Product Details</Text>
                </View>
            </TouchableOpacity>
        )
    });
        ...
        <View className='flex-1 bg-[#121212] p-3'>
            <ScrollView contentContainerStyle={{ alignItems: "center", paddingBottom: 100 }}>
                ...
                <View className='w-full  mt-4 mb-3 p-3 flex-row justify-between items-center'>
                    <View className='flex-col'><Text className='text-white font-prostoOne'>Super Basic Black Tee</Text><Text className='text-white font-prostoOne'>$70</Text></View>
                ...
                <View className='p-3'>
                    <Text numberOfLines={isReadMore ? 2 : undefined} className='font-prostoOne text-white'>
                ...
                <View className='w-full p-3 '>
                    <Text className='text-[#ADAEBC] font-prostoOne mb-2'>Color</Text>
                    ...
                    <Text className='text-[#ADAEBC] font-prostoOne mt-2'>Custome Size</Text>
