        ...
        <Modal visible={visible} onRequestClose={onClose}>
            <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: '#121212',  }}>
                ...
                <ScrollView contentContainerStyle={{ padding: 15, paddingBottom: 100 }}>
                    ...
                    <Text className='text-white text-xl mt-2 mb-2 font-poppins'>Available In-App</Text>
                    ...
                    <Text className='text-white text-xl mt-2 mb-2 font-poppins'>Similar Items Online</Text>
                        ...
                        <View className='flex-row gap-2'>
                            ...
                            <View className='flex-1'>
                                <View className='flex-row justify-between flex-1'>
                                    <View>
                                        <Text className='text-white font-poppins text-xl'>Black Formal Dress</Text>
                                        <Text className='text-[#9CA3AF]'>Nordstrom</Text>
                                    </View>
                                    <Image source={require("../../../assets/e-icon/link.png")} style={{ width: 12, height: 12 }} />
                                </View>
                                <View className='flex-row gap-3 items-center'>
                                    <Text className='text-white text-xl'>$329</Text>
                                    <View className='flex-row gap-1 items-center '>
                                        <Image source={require("../../../assets/e-icon/amazon.png")} style={{ width: scale(16), height: verticalScale(16) }} />
                                        <Text className='text-[#9CA3AF]'>Amazon</Text>
                                    </View>
