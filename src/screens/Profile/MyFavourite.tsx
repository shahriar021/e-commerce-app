import { View, Text, Image, TextInput, TouchableOpacity, ScrollView, useWindowDimensions, ActivityIndicator } from 'react-native'
        ...
        <View className='flex-1 bg-[#121212] p-3'>
            <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
                <View className='flex-row flex-wrap  justify-between gap-2'>
                    {getFavData?.data?.data?.length>0?getFavData?.data?.data?.map((item,index) =>
