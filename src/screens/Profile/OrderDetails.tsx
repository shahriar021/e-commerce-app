        ...
        <ScrollView contentContainerStyle={{ padding: 10 }}>
            <View className='flex-row justify-between items-center bg-[#212121] p-2 rounded-lg mt-2'>
                <View className='flex-col'>
                    <Text className='text-[#fff] font-instrumentSansSemiBold text-xl'>Order #83473</Text>
                    <Text className='text-[#9CA3AF] font-instrumentRegular'>June 24,2025</Text>
                </View>
            ...
            <View className=' bg-[#212121] p-2 rounded-lg mt-2 '>
                ...
                <View className='flex-row gap-3 items-center'>
                    ...
                    <Text className='font-instrumentSansSemiBold text-[#fff] text-lg'>Sarra ahmed</Text>
                </View>
                <View className='flex-row gap-3 items-center'>
                    <Image source={require("../../../assets/e-icon/Call.png")} style={{ width: 20, height: 18 }} />
                    <Text className='font-instrumentSansSemiBold text-[#fff] text-lg'>2353563464664</Text>
                </View>
                <View className='flex-row gap-3 items-center'>
                    <Image source={require("../../../assets/e-icon/n.png")} style={{ width: 20, height: 18 }} />
                    <Text className='font-instrumentSansSemiBold text-[#fff] text-lg' style={{flexShrink:1}}>House 25, Road 7
            ...
            <View className=' bg-[#212121] p-2 rounded-lg mt-2'>
                ...
                <View className='flex-row justify-between'>
                    ...
                    <Text className='text-[#ADAEBC] font-instrumentSansSemiBold'>Paypel</Text>
                </View>
                <View className='flex-row justify-between mt-2'>
                    <Text className='text-[#ADAEBC] font-instrumentSansSemiBold'>Payment Status</Text>
                    <Text className='text-[#4ADE80] font-instrumentSansSemiBold'>Paid</Text>
