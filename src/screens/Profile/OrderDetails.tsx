        ...
        <ScrollView contentContainerStyle={{ padding: 10 }}>
            <View className='flex-row justify-between items-center bg-[#212121] p-2 rounded-lg mt-2'>
                <View className='flex-col'>
                    <Text className='text-[#fff] font-prostoOne text-xl'>Order #83473</Text>
                    <Text className='text-[#9CA3AF] font-prostoOne'>June 24,2025</Text>
                </View>
            ...
            <View className=' bg-[#212121] p-2 rounded-lg mt-2'>
                <Text className='text-xl font-prostoOne text-[#fff]'>MY Information</Text>
                <View className='flex-row gap-3 items-center'>
                    <Image source={require("../../../assets/e-icon/2 User.png")} style={{ width: 20, height: 18 }} />
                    <Text className='font-prostoOne text-[#fff] text-lg'>Sarra ahmed</Text>
                </View>
                <View className='flex-row gap-3 items-center'>
                    <Image source={require("../../../assets/e-icon/Call.png")} style={{ width: 20, height: 18 }} />
                    <Text className='font-prostoOne text-[#fff] text-lg'>2353563464664</Text>
                </View>
                <View className='flex-row gap-3 items-center'>
                    <Image source={require("../../../assets/e-icon/n.png")} style={{ width: 20, height: 18 }} />
                    <Text className='font-prostoOne text-[#fff] text-lg'>House 25, Road 7
                        Dhanmondi, Dhaka-1205</Text>
                </View>
            </View>

            <View className=' bg-[#212121] p-2 rounded-lg mt-2'>
                <Text className='text-xl font-prostoOne text-[#fff]'>Payment Information</Text>
                <View className='flex-row justify-between'>
                    <Text className='text-[#ADAEBC] font-prostoOne'>Payment Method</Text>
                    <Text className='text-[#ADAEBC] font-prostoOne'>Paypel</Text>
                </View>
                <View className='flex-row justify-between mt-2'>
                    <Text className='text-[#ADAEBC] font-prostoOne'>Payment Status</Text>
                    <Text className='text-[#4ADE80] font-prostoOne'>Paid</Text>

                </View>
                <View className='border border-[#565656] mt-2'/>
                 <View className='flex-row justify-between'>
                    <Text className='text-[#ADAEBC] font-prostoOne'>Subtotal</Text>
                    <Text className='text-[#ADAEBC] font-prostoOne'>৳4,400</Text>
                </View>
                <View className='flex-row justify-between mt-2'>
                    <Text className='text-[#ADAEBC] font-prostoOne'>Shipping Fee</Text>
                    <Text className='text-[#ADAEBC] font-prostoOne'>৳80</Text>

                </View>
                <View className='border border-[#565656] mt-2'/>
                <View className='flex-row justify-between mt-2'>
                    <Text className='text-[#ADAEBC] font-prostoOne'>Total</Text>
                    <Text className='text-[#ADAEBC] font-prostoOne'>৳4,480</Text>
